...
// CARGAR DESPLEGABLES DE SECTORES (ORDENADOS ALFABÉTICAMENTE)
function actualizarSelectSectoresUsuarios() {
    ...
    selects.forEach(select => {
        ...
        select.innerHTML = '<option value="">-- Seleccione Sector (Escriba para buscar) --</option>';
...
function actualizarSelectProveedoresEstadisticas() {
    ...
    if (!select) return;
    select.innerHTML = '<option value="">-- Seleccione un Proveedor (Escriba para buscar) --</option>';
...
function abrirModalGraficos() {
    ...
    if (select) {
        select.innerHTML = '<option value="TODOS">-- Todos los Proveedores (Escriba para buscar) --</option>';
...
function actualizarSelectsCompras() {
    ...
    if (selectCondPago) {
        selectCondPago.innerHTML = '<option value="">-- Seleccione Condición (Escriba para buscar) --</option>';
...
function actualizarSelectOrdenesPendientes() {
    ...
    if (!select) return;
    select.innerHTML = '<option value="">-- Seleccione Orden Pendiente (Escriba para buscar) --</option>';
